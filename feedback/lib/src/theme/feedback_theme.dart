...
class FeedbackThemeData {
  ...
  FeedbackThemeData(
      ...
      this.useFullScreenFeedbackForm = false,
      this.controlsColumnExtraActions,
  ...
  /// Si `true`, la bottom sheet de saisie n’est pas affichée pendant l’annotation :
  /// la zone de capture occupe (presque) tout l’écran. Le formulaire s’ouvre via
  /// [FeedbackController.presentFeedbackForm] (bouton dans la barre d’outils).
  final bool useFullScreenFeedbackForm;

  /// Widgets supplémentaires dans la colonne d’outils (à droite), après le bouton
  /// d’ouverture du formulaire (si présent) et **avant** Annuler / Effacer / couleurs.
  final List<Widget> Function(BuildContext context)? controlsColumnExtraActions;
  ...
  FeedbackThemeData copyWith({
    ...
    bool? useFullScreenFeedbackForm,
    List<Widget> Function(BuildContext context)? controlsColumnExtraActions,
    Color? dragHandleColor,
    Brightness? brightness,
    ColorScheme? colorScheme,
  }) {
    return FeedbackThemeData(
      ...
      useFullScreenFeedbackForm:
          useFullScreenFeedbackForm ?? this.useFullScreenFeedbackForm,
      controlsColumnExtraActions:
          controlsColumnExtraActions ?? this.controlsColumnExtraActions,
