...
class ControlsColumn extends StatelessWidget {
  ...
  /// Ouvre / agrandit la bottom sheet de saisie (feuille draggable).
  final VoidCallback? onExpandFeedbackSheet;

  /// Widgets additionnels après le bouton formulaire, avant Annuler (ex. déconnexion).
    ...
    return Card(
      ...
      child: Wrap(
        ...
        children: <Widget>[
          ...
          if (onExpandFeedbackSheet != null) ...[
            _ColumnDivider(),
            IconButton(
              key: const ValueKey<String>('expand_feedback_sheet_button'),
              tooltip: 'Ouvrir le formulaire',
              icon: Icon(
                Icons.post_add_rounded,
                color: FeedbackTheme.of(context).activeFeedbackModeColor,
              ),
              onPressed: onExpandFeedbackSheet,
            ),
          ],
          if (controlsColumnExtraActions != null)
            ...controlsColumnExtraActions!(context),
          IconButton(
