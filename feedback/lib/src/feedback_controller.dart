...
class FeedbackController extends ChangeNotifier {
  ...
  /// Ouvre le formulaire en plein écran ([FeedbackThemeData.useFullScreenFeedbackForm]).
  VoidCallback? _presentFeedbackForm;

  void bindPresentFeedbackForm(VoidCallback? fn) {
    _presentFeedbackForm = fn;
  }

  void presentFeedbackForm() => _presentFeedbackForm?.call();
}
